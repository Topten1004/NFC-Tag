...
public class JsonTaskMateriel extends AsyncTask<String, String, Materiel> {

    public JsonTaskMateriel() {
        super();
    }

    protected Materiel doInBackground(String... params) {
...
//            connection.setRequestProperty("Authorization", "Bearer " + params[1]);
            ...
            if(authOk){
                Type t = new TypeToken<Materiel>(){}.getType();
    ...
    @Override
    protected void onPostExecute(Materiel result) {
